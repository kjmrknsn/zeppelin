...
<table class="table-configuration">
  ...
  <tr>
    <td><h6 class="properties">ZEPPELIN_NOTEBOOK_QUARTZ_PROP_PATH</h6></td>
    <td><h6 class="properties">zeppelin.notebook.quartz.prop.path</h6></td>
    <td></td>
    <td>path of quartz.properties</td>
  </tr>
  <tr>
